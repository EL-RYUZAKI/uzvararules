...
17. Желательно иметь доказательство вины игрока для наказания (бан, кик, джайл). Свидетели не являются доказательством вины. главная администрация (основатели сервера, администраторы) в любой момент может попросить предъявить доказательства вины, и если их нет, вас могут наказать.
