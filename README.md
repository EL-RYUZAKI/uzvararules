...
● Стоять на КПП ведущий в запретный сектор.
● Контактировать с ОТА. 
● Контактировать с CMD.OTA, если CMD.OTA не начинал диалог.
<br>
...
● Контактировать с ОТА.
● Контактировать с CMD.OTA, если CMD.OTA не начинал диалог.
● Иметь другое огнестрельное оружие, чем изначально выданное.

## CMD.UNIT 
_**`Запрещено:`**_
● Запрещено отдавать приказы OTA.
● Устраивать рейды в запретный сектор.
_**`Разрешено:`**_
● Устраивать рабочую фазу
● Устраивать Построение.
● Устроить массовый расстрел граждан [с очень особой причиной].
● Отменить Ком.час по ночам [с очень особой причиной].
● Устраивать Ком.час днём [с очень особой причиной].
...
_**`Запрещено:`**_
● Командовать ГО.
● Устраивать рейды без весомой на это причины.
● Выпускать OTA в мирное время.
_**`Разрешено:`**_
● Устроить полное расформирование ГО/ЛИКВИДАЦИЯ [С очень весомой на это причиной, с разрешением главного Администратора.].
● Устраивать Рейд на Сопротивление [с весомой на это причиной]
...
● Нет 25% из 100% Граждан на построение - Отклонение численности.
● Массовый побег граждан (больше 2 за раз)
