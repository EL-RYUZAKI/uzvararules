# Внимание
При присоединении на сервер вы принимаете условия всех правил "Uzvara HL2RP".
Вы несёте полную ответственность за нарушения правил сервера и можете быть наказаны Администратором по усмотрению.
В случае виновности Администратора допускается подача жалобы/обжалования в соответствующей категории, канале, в дискорде Uzvara.
...
6. Запрос/вызов администрации производится командой "!rep", "!report" [Дальше пишите жалобу, Правила Uzvara включены]
...
4. Разрешено выходить за пределы запрещено сектора(игрового времени) с 22.00-6.00.
