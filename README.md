...
2. Запрещается злоупотреблять данной вам привилегией.
3. Выдача любых ресурсов игрокам запрещено. (Не касается ивентов)
4. апрещается использования Noclip в любых целях. (Кроме
Администрирования)
5. Нарушение любого правила администратором сервера
карается намного серьезней чем нарушение обычного игрока.
6. Категорически запрещено трогать игрока "Physic gun" в RP.
7. Запрещается снимать наказание выданное другим
администратором/модератором (Исключение: основной
администратор выше ранга “наказывающего” администратора)
8. Запрещается игнорировать жалобы, просьбы о помощи.
(Исключение: вы заняты другим "репортом")
9. Запрещается игнорировать нарушение любых игроков
сервера. (Даже если это ваши друзья)
10. Каждый администратор (основной) обязан проводить не менее
3 часов на сервере.(В день)
11. Каждый администратор обязан знать правила сервера.
12. Любой администратор обязан выполнять указания
"Основателя/Со основателя/Смотрителя" сервера
13. Администратору запрещается портить атмосферу игроков:
Телепорты без разрешения игроков. (Только по важным случьям)
14. Запрещено вести себя нервно с игроками, повышать тон на них и прочее.
15. При вашем увольнение, вы имеете право подать заявку через месяц.
16. Администратор обязан уважительно разговаривать с высшей администрацией.
17.1. Желательно иметь доказательство вины игрока для наказания (бан, кик, джайл). Свидетели не являются доказательством вины. главная администрация (основатели сервера, администраторы) в любой момент может попросить предъявить доказательства вины, и если их нет, вас могут наказать.
